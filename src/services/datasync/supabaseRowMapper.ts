...
export const SUPABASE_TABLE_COLUMNS: Record<string, string[]> = {
  ...
  school_settings: ['id', 'name', 'trade_name', 'inep_code', 'cnpj', 'accreditation_decree', 'address', 'city', 'state', 'phone', 'email', 'principal_name', 'secretary_name', 'logo_url', 'created_at', 'updated_at', 'neighborhood', 'zip_code', 'website', 'principal_title', 'secretary_registration', 'system_version', 'management_logo_url'],
  school_units: ['id', 'name', 'code', 'type', 'inep_code', 'city', 'state', 'principal_name', 'phone', 'email', 'active', 'created_at', 'updated_at', 'logo_url', 'management_logo_url'],
