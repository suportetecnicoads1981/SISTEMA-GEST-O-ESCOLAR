-- =============================================================================
-- Habilidades BNCC (24/09/2026)
--  - bncc_skills: catálogo de habilidades (código, ano/etapa, componente, descrição)
--  - bncc_skill_assessments: lançamento do nível de cada habilidade por aluno e bimestre
--
-- O id do lançamento é determinístico (aluno + habilidade + ano + bimestre), então o mesmo
-- lançamento feito em computadores diferentes vira um único registro na nuvem.
...
-- Catálogo: equipe (ADMIN/TEACHER) lê e grava; somente ADMIN exclui.
...
-- Lançamentos: equipe lê, grava e também exclui (apagar um nível lançado é tarefa do professor).
...
-- Escolas excluídas de propósito também não recebem lançamentos (mesma trava de alunos/turmas).
